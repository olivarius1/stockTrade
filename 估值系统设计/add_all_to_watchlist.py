...
DB_PATH = '/Users/zhanghe/MyProjs/trade/eval_sys/stockTrade/backend/data/valuation.db'
...
def add_to_watchlist(stock_code, stock_name, industry, model_type):
    ...
    try:
        c.execute('''
            INSERT INTO watchlist (stock_code, stock_name, industry, model_type, ai_enabled)
            VALUES (?, ?, ?, ?, ?)
